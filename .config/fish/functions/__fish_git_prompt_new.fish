...
set -g fish_git_prompt_color_upstream (set_color normal)
set -g fish_git_prompt_color_dirty (set_color blue)
set -g fish_git_prompt_color_invalid (set_color red)
set -g fish_git_prompt_color_staged (set_color yellow)
set -g fish_git_prompt_color_untracked (set_color normal)
set -g fish_git_prompt_color_stashes (set_color purple)
set -g fish_git_prompt_color_clean (set_color green)
set -g fish_git_prompt_color_branch (set_color -o magenta)
