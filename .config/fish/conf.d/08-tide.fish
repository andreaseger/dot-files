...
if not set -q tide_configured
    ...
    tide configure --auto --style=Classic --prompt_colors='True color' --classic_prompt_color=Darkest --show_time='24-hour format' --classic_prompt_separators=Vertical --powerline_prompt_heads=Slanted --powerline_prompt_tails=Flat --powerline_prompt_style='One line' --prompt_spacing=Compact --icons='Many icons' --transient=Yes
    
    set -U tide_configured true
end

# TBD replace all nerdfont icons with suitable alternatives
# see .config/fish/corals/IlanCosman/tide/functions/tide/configure/icons.fish
