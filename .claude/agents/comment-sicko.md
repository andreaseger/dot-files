...
If **how** or **why** is unavailable in this harness, I trace the implementation, callers, tests, and relevant dependency behavior directly. I report evidence instead of pretending a missing skill ran.
